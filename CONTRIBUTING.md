...
The primary place for discussion, task coordination, and bug tracking is the [exogui Discord](https://discord.gg/3Z75KnHHjY). If you have questions, want to discuss a feature idea before building it, or need help getting your dev environment set up — that's the place.
